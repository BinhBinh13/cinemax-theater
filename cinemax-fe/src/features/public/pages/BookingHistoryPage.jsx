...
import { getBookingHistory } from '@/shared/services/bookingService'
              ...
              {bookings.length === 0 ? (
                ...
                <div className="d-flex flex-column gap-4">
                  {bookings.map((booking) => {
                    const bookingTimeStr = new Date(booking.bookingTime).toLocaleString('vi-VN', {
                      year: 'numeric',
                      month: '2-digit',
                      day: '2-digit',
                      hour: '2-digit',
                    ...
                    const showtimeStr = new Date(booking.startTime).toLocaleString('vi-VN', {
                      weekday: 'long',
                      year: 'numeric',
                      month: '2-digit',
                      day: '2-digit',
                              ...
                              <div>
                                ...
                                <div className="d-flex flex-wrap gap-1 justify-content-md-end">
                                  {booking.tickets.map((ticket) => (
                                    <Badge key={ticket.ticketId} bg="dark" className="border border-secondary border-opacity-20 px-2 py-1.5 fs-7">
                                      {ticket.seatRow}{ticket.seatColumn} ({ticket.seatType})
                                    </Badge>
                                  ))}
                                </div>
                              </div>
