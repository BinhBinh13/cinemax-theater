    ...
    if (!hasAccess) {
      return (
        <div 
          ...
          style={{ height: '100vh', width: '100vw' }}
        >
          <div className="text-center p-5 border border-secondary rounded bg-secondary bg-opacity-25" style={{ maxWidth: '500px' }}>
            <h1 className="text-danger mb-4">403 - Không có quyền truy cập</h1>
            <p className="lead mb-4">
              Tài khoản của bạn có vai trò là <strong className="text-gold">Khách hàng</strong> nên không có quyền truy cập vào trang quản lý dành cho nhân viên.
            </p>
            <button 
